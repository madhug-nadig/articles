...
The dataset will be divided into _'test'_ and _'training'_ samples for cross validation. The training set will be used to 'teach' the algorithm about the dataset, ie. to build a model, which in the case of k-NN algorithm happens during active runtime during prediction. The test set will be used for evaluation of the results.
